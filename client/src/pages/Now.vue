<template>
  <div class="container">
    <!-- 设备相关内容 -->
    <h2 class="device_h2" v-show="Pinia.device_sign">不同传感器设备的最近5分钟的设备数据记录</h2>
    <h2 class="device_h2" v-show="!Pinia.device_sign">传感器设备的最近5分钟的数据记录</h2>
    ...
    <div id="latestData" v-show="Pinia.action_sign && Pinia.Action_sign">
      ...
      <!-- 最新信息的提示 -->
      <h2 class="newest_action">用于展示最新行为记录的表格</h2>
      ...
      <table v-if="nowArray1 && nowArray1[1] && nowArray1[1].length > 0 && d_length > 0" class="table_action">
        <thead>
          <tr>
            ...
            <th>{{ yingshe_action_array[0].field1 }} ({{ unit_action_array[0] }})</th>
            <th>{{ yingshe_action_array[1].field2 }} ({{ unit_action_array[1] }})</th>
            <th>{{ yingshe_action_array[2].field3 }} ({{ unit_action_array[2] }})</th>
            <th>创建时间</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td v-if="Pinia.device_sign">{{ nowArray1[0] }}</td>
...
(async () => {
  ...
  chartOption0 = ref({
    ...
    legend: {
      data: [yingshe_action_array.value[0].field1, yingshe_action_array.value[1].field2, yingshe_action_array.value[2].field3]
    },
    grid: {
      left: '3%',
      right: '4%',
    ...
    series: [
      ...
      {
        name: yingshe_action_array.value[2].field3,
        type: 'line',
        smooth: true,
  ...
  chartOption11.value.series[2].data = [];
